...
public class ActiveDatabases {
    ...
    public static ActiveDatabases getInstance() throws NeedActiveContextException {
        if (instance==null) throw new NeedActiveContextException();
        return instance;
    }
    ...
    public static class NeedActiveContextException extends Throwable{
