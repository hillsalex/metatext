            ...
            if (retrieveConfData != null) {
                ...
                if ((pdu == null) || (pdu.getMessageType() != MESSAGE_TYPE_RETRIEVE_CONF)) {
                    ...
                    /*try {
                        ...
                        android.util.Log.d(TAG,"FUCK THIS, batch was a problem: " + e.getMessage());
                        e.printStackTrace();
                    }
                    android.util.Log.d(TAG,"End delete time: "+ DateFormat.getDateTimeInstance().format(new Date()));
                    android.util.Log.d(TAG,"Start 2nd delete time: "+ DateFormat.getDateTimeInstance().format(new Date()));
                    SqliteWrapper.delete(mContext, mContext.getContentResolver(),
                            mUri, null, null);
                    android.util.Log.d(TAG,"End 2nd delete time: "+ DateFormat.getDateTimeInstance().format(new Date()));
                    */
