...
/*
    ...
    public static void trimThread(final Context context, final long threadId) {
        boolean trimmingEnabled   = TexterPreferences.isThreadLengthTrimmingEnabled(context);
        final int     threadLengthLimit = TexterPreferences.getThreadTrimLength(context);
